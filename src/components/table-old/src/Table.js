  ...
  const filter = {
    [filterLabel[0]]: (dataF) =>
      setDataCopy(() =>
        dataF.filter(
          (item) =>
            getArr(item).toLowerCase() === filterText.toLowerCase().trim()
        )
      ),
    [filterLabel[1]]: (dataF) =>
      setDataCopy(() =>
    ...
    [filterLabel[2]]: (dataF) =>
      setDataCopy(() => dataF.filter((item) => getArr(item) === "")),
    [filterLabel[3]]: (dataF) =>
      setDataCopy(() => dataF.filter((item) => getArr(item) !== "")),
    [filterLabel[4]]: (dataF) =>
      setDataCopy(() => dataF.filter((item) => getArr(item) === filterText)),
    [filterLabel[5]]: (dataF) =>
      setDataCopy(() => dataF.filter((item) => getArr(item) !== filterText)),
    [filterLabel[6]]: (dataF) =>
      setDataCopy(() =>
        dataF.filter((item) =>
          getArr(item).toLowerCase().startsWith(filterText.toLowerCase().trim())
        )
      ),
    [filterLabel[7]]: (dataF) =>
      setDataCopy(() =>
        dataF.filter((item) =>
          getArr(item).toLowerCase().endsWith(filterText.toLowerCase().trim())
        )
      ),
    [filterLabel[8]]: (dataF) =>
      setDataCopy(() =>
        dataF.filter((item) =>
          getArr(item).toLowerCase().includes(filterText.toLowerCase().trim())
        )
      ),
    [filterLabel[9]]: (dataF) =>
      setDataCopy(() =>
...
Table.propTypes = {
  ...
  paginationSmartColor: PropTypes.string,
};
